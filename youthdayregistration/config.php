<?php
	...
	define('SITE_NAME' , "Youthday Registration");
	...
	define('APP_ID',"2ec005a01893f9a1dec029cad7b96a5b");
	...
	define('DB_PASSWORD','');
	define('DB_NAME','holy_youthday_register');
	...
	define('USER_ID',(isset($_SESSION[APP_ID.'user_data']) ? $_SESSION[APP_ID.'user_data']['kd_akun'] : null ));
