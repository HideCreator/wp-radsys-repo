...
$can_add = PageAccessManager::is_allowed('tmpdata/add');
$can_edit = PageAccessManager::is_allowed('tmpdata/edit');
$can_view = PageAccessManager::is_allowed('tmpdata/view');
$can_delete = PageAccessManager::is_allowed('tmpdata/delete');
?>
    ...
    <div  class="bg-light p-3 mb-3">
        <div class="container-fluid">
            ...
            <div class="row ">
                ...
                <div class="col-sm-4 ">
                    <h3 class="record-title">Tmpdata</h3>
                ...
                <div class="col-sm-3 ">
                    ...
                    <a  class="btn btn btn-primary my-1" href="<?php print_link("tmpdata/add") ?>">
                            ...
                            <nav class="page-header-breadcrumbs mt-2" aria-label="breadcrumb">
                                <ul class="breadcrumb m-0 p-1">
                                    ...
                                    <li class="breadcrumb-item">
                                        <a class="text-capitalize" href="<?php print_link('tmpdata'); ?>">
                                    ...
                                    ?>
                                    <li class="breadcrumb-item">
                                        <a class="text-capitalize" href="<?php print_link('tmpdata') ?>">Search</a>
                                    </li>
