    ...
    <div  class="bg-light p-3 mb-3">
        <div class="container">
            ...
            <div class="row ">
                ...
                <div class="col-12 ">
                    <h3 class="record-title">Add New Tmpdata</h3>
            ...
            <div class="row ">
                ...
                <div class="col-md-7 comp-grid">
                    ...
                    <div  class=" animated fadeIn">
                        <form id="tmpdata-add-form" role="form" novalidate enctype="multipart/form-data" class="form form-vertical needs-validation" action="<?php print_link("tmpdata/add?csrf_token=$csrf_token") ?>" method="post">
                            <div>
                                ...
                                <div class="form-group ">
                                    ...
                                    <div id="ctrl-id-holder" class=""> 
                                        <input id="ctrl-id"  value="<?php  echo $this->set_field_value('id','0'); ?>" type="number" placeholder="Enter Id" step="1"  required="" name="id"  class="form-control " />
