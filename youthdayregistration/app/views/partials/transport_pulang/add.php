    ...
    <div  class="bg-light p-3 mb-3">
        <div class="container">
            ...
            <div class="row ">
                ...
                <div class="col-12 ">
                    <h3 class="record-title">Add New Transport Pulang</h3>
            ...
            <div class="row ">
                ...
                <div class="col-md-7 comp-grid">
                    ...
                    <div  class=" animated fadeIn">
                        <form id="transport_pulang-add-form" role="form" novalidate enctype="multipart/form-data" class="form form-vertical needs-validation" action="<?php print_link("transport_pulang/add?csrf_token=$csrf_token") ?>" method="post">
                            <div>
                                ...
                                <div class="form-group ">
                                    ...
                                    <div class="form-group ">
                                        ...
                                        <div id="ctrl-nama_transport_pulang-holder" class=""> 
                                            <input id="ctrl-nama_transport_pulang"  value="<?php  echo $this->set_field_value('nama_transport_pulang',''); ?>" type="text" placeholder="Enter Nama Transport Pulang"  required="" name="nama_transport_pulang"  class="form-control " />
