    ...
    <div  class="bg-light p-3 mb-3">
        <div class="container-fluid">
            ...
            <div class="row ">
                ...
                <div class="col-sm-4 ">
                    <h3 class="record-title">Verifikasi</h3>
                ...
                <div class="col-sm-3 ">
                    ...
                    <a  class="btn btn btn-primary my-1" href="<?php print_link("verifikasi/add") ?>">
                            ...
                            <nav class="page-header-breadcrumbs mt-2" aria-label="breadcrumb">
                                <ul class="breadcrumb m-0 p-1">
                                    ...
                                    <li class="breadcrumb-item">
                                        <a class="text-capitalize" href="<?php print_link('verifikasi'); ?>">
                                    ...
                                    ?>
                                    <li class="breadcrumb-item">
                                        <a class="text-capitalize" href="<?php print_link('verifikasi') ?>">Search</a>
                                    </li>
                ...
                <div class="row ">
                    ...
                    <div class="col-md-12 comp-grid">
                        ...
                        <div  class=" animated fadeIn">
                            <div id="verifikasi-list-records">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <th class=" td-checkbox">
                                                    <label class="custom-control custom-checkbox custom-control-inline">
                                                        <input class="optioncheck custom-control-input" name="optioncheck[]" value="<?php echo $data['kd_verifikasi'] ?>" type="checkbox" />
                                                            <span class="custom-control-label"></span>
                                                        </label>
                                                    </th>
                                                    ...
                                                    <td>
                                                        <a <?php if($can_edit){ ?> data-step="1" 
                                                            ...
                                                            data-value="<?php echo $data['kd_verifikasi']; ?>" 
                                                            data-pk="<?php echo $data['kd_verifikasi'] ?>" 
                                                            data-url="<?php print_link("verifikasi/editfield/" . urlencode($data['kd_verifikasi'])); ?>" 
                                                            data-name="kd_verifikasi" 
                                                            data-title="Enter Kd Verifikasi" 
                                                            data-placement="left" 
                                                            data-toggle="click" 
                                                            data-type="number" 
                                                            data-mode="popover" 
                                                    ...
                                                    <td>
                                                        <a <?php if($can_edit){ ?> data-step="1" 
                                                            data-source='<?php echo json_encode_quote(Menu :: $kd_akun); ?>' 
                                                            data-value="<?php echo $data['id_mutasi']; ?>" 
                                                            data-pk="<?php echo $data['kd_verifikasi'] ?>" 
                                                            data-url="<?php print_link("verifikasi/editfield/" . urlencode($data['kd_verifikasi'])); ?>" 
                                                            data-name="id_mutasi" 
                                                            data-title="Enter Id Mutasi" 
                                                            data-placement="left" 
                                                            data-toggle="click" 
                                                            data-type="number" 
                                                            data-mode="popover" 
                                                    ...
                                                    <th class="td-btn">
                                                        ...
                                                        <a class="btn btn-sm btn-success has-tooltip" title="View Record" href="<?php print_link("verifikasi/view/$rec_id"); ?>">
                                                            <i class="fa fa-eye"></i> 
                                                        </a>
                                                        ...
                                                        <a class="btn btn-sm btn-info has-tooltip" title="Edit This Record" href="<?php print_link("verifikasi/edit/$rec_id"); ?>">
                                                        ...
                                                        <a class="btn btn-sm btn-danger has-tooltip record-delete-btn" title="Delete this record" href="<?php print_link("verifikasi/delete/$rec_id/?csrf_token=$csrf_token&redirect=$current_page"); ?>" data-prompt-msg="Are you sure you want to delete it?" data-display-style="none">
                                        ...
                                        <div class="row">   
                                            <div class="col-sm-4">  
                                                <div class="py-2">  
                                                    ...
                                                    <button data-prompt-msg="Are you sure you want to delete these records?" data-display-style="none" data-url="<?php print_link("verifikasi/delete/{sel_ids}/?csrf_token=$csrf_token&redirect=$current_page"); ?>" class="btn btn-sm btn-danger btn-delete-selected d-none">
