    ...
    <div  class="bg-light p-3 mb-3">
        <div class="container">
            ...
            <div class="row ">
                ...
                <div class="col-12 ">
                    <h3 class="record-title">Add New Detailbca</h3>
            ...
            <div class="row ">
                ...
                <div class="col-md-7 comp-grid">
                    ...
                    <div  class=" animated fadeIn">
                        <form id="detailbca-add-form" role="form" novalidate enctype="multipart/form-data" class="form form-vertical needs-validation" action="<?php print_link("detailbca/add?csrf_token=$csrf_token") ?>" method="post">
                            <div>
