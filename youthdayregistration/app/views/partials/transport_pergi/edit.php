    ...
    <div  class="bg-light p-3 mb-3">
        <div class="container">
            ...
            <div class="row ">
                ...
                <div class="col-12 ">
                    <h3 class="record-title">Edit  Transport Pergi</h3>
            ...
            <div class="row ">
                ...
                <div class="col-md-7 comp-grid">
                    ...
                    <div  class=" animated fadeIn">
                        <form novalidate  id="" role="form" enctype="multipart/form-data"  class="form form-vertical needs-validation" action="<?php print_link("transport_pergi/edit/$page_id/?csrf_token=$csrf_token"); ?>" method="post">
                            <div>
                                ...
                                <div class="form-group ">
                                    ...
                                    <div class="form-group ">
                                        ...
                                        <div id="ctrl-nama_transport_pergi-holder" class=""> 
                                            <input id="ctrl-nama_transport_pergi"  value="<?php  echo $data['nama_transport_pergi']; ?>" type="text" placeholder="Enter Nama Transport Pergi"  required="" name="nama_transport_pergi"  class="form-control " />
                                                ...
                                                <div class="form-group ">
                                                    ...
                                                    <div class="form-group ">
                                                        ...
                                                        <div id="ctrl-diskon_pp-holder" class=""> 
                                                            <input id="ctrl-diskon_pp"  value="<?php  echo $data['diskon_pp']; ?>" type="number" placeholder="Enter Diskon Pp" step="1"  required="" name="diskon_pp"  class="form-control " />
