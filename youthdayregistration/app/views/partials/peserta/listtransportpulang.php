    ...
    <div  class="bg-light p-3 mb-3">
        <div class="container-fluid">
            ...
            <div class="row ">
                ...
                <div class="col-sm-4 ">
                    <h3 class="record-title">List Transport Pulang</h3>
                ...
                <div class="row ">
                    ...
                    <div class="col-md-12 comp-grid">
                        ...
                        <div  class=" animated fadeIn">
                            <div id="peserta-listtransportpulang-records">
                                ...
                                <div class="page-records table-responsive">
                                    <table class="table  table-sm table-bordered">
                                        ...
                                        <tbody>
                                            ...
                                            <?php
                                            $counter = 0;
                                            $sum_of_harga_transport_pulang = 0;
                                            foreach($records as $data){
                                            $rec_id = (!empty($data['kd_peserta']) ? urlencode($data['kd_peserta']) : null);
                                            $counter++;
                                            $sum_of_harga_transport_pulang = $sum_of_harga_transport_pulang + $data['harga_transport_pulang'];
                                            ...
                                            <tr>
                                                ...
                                                <td> <?php echo $data['transport_catatan']; ?> </td>
                                        ...
                                        <tfoot>
                                            <tr>
                                                <td></td><td></td><td></td><td></td><td></td><td></td><td></td><td><h4>Total Arrival Price = <?php echo $sum_of_harga_transport_pulang;  ?></h4></td><td></td><td></td>
                                            </tr>
                                        </tfoot>
                                    </table>
                                </div>
