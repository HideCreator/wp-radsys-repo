    ...
    <div  class="bg-light p-3 mb-3">
        <div class="container-fluid">
            ...
            <div class="row ">
                ...
                <div class="col-sm-4 ">
                    <h3 class="record-title">List Transport Pergi</h3>
                ...
                <div class="row ">
                    ...
                    <div class="col-md-12 comp-grid">
                        ...
                        <div  class=" animated fadeIn">
                            <div id="peserta-listtransportpergi-records">
                                ...
                                <div class="page-records table-responsive">
                                    <table class="table  table-sm table-bordered">
                                        ...
                                        <tbody>
                                            ...
                                            <?php
                                            $counter = 0;
                                            $sum_of_harga_transport_pergi = 0;
                                            foreach($records as $data){
                                            $rec_id = (!empty($data['kd_peserta']) ? urlencode($data['kd_peserta']) : null);
                                            $counter++;
                                            $sum_of_harga_transport_pergi = $sum_of_harga_transport_pergi + $data['harga_transport_pergi'];
                                        ...
                                        <tfoot>
                                            <tr>
                                                <td></td><td></td><td></td><td></td><td></td><td></td><td></td><td><h4>Total Departure Price = <?php echo $sum_of_harga_transport_pergi;  ?></h4></td><td></td><td></td>
                                            </tr>
                                        </tfoot>
                                    </table>
                                </div>
