    ...
    <div  class="bg-light p-3 mb-3">
        <div class="container">
            <div class="row justify-content-between">
                <div class="col ">
                    <h5 class="font-weight-bold record-title">Edit Pelanggan Cafe</h5>
                </div>
            </div>
        </div>
    </div>
            ...
            <div class="row ">
                <div class="col-md-9 comp-grid">
                    ...
                    <div  class="card bg-light p-3 animated fadeIn page-content">
                        <!--[form-start]-->
                        <form novalidate  id="" role="form" enctype="multipart/form-data"  class="form page-form form-vertical needs-validation" action="<?php print_link("pelanggan_cafe/edit/$rec_id"); ?>" method="post">
                        <!--[form-content-start]-->
                        @csrf
                        <div>
                            ...
                            <div class="form-group ">
                                ...
                                <div id="ctrl-kodepos-holder" class=" "> 
                                    <input id="ctrl-kodepos"  value="<?php  echo $data['kodepos']; ?>" type="text" placeholder="Enter Kodepos"  required="" name="kodepos"  class="form-control " />
                                </div>
                            </div>
                            <div class="form-group ">
                            ...
                            <div class="form-group ">
                                ...
                                <div id="ctrl-catatan_pelanggan-holder" class=" "> 
                                    <textarea placeholder="Enter Catatan Pelanggan" id="ctrl-catatan_pelanggan"  rows="5" name="catatan_pelanggan" class=" form-control"><?php  echo $data['catatan_pelanggan']; ?></textarea>
                            ...
                            <div class="form-group ">
                                ...
                                <div id="ctrl-prediksi_ongkir-holder" class=" "> 
                                    <input id="ctrl-prediksi_ongkir"  value="<?php  echo $data['prediksi_ongkir']; ?>" type="number" placeholder="Enter Prediksi Ongkir" step="any"  name="prediksi_ongkir"  class="form-control " />
                                </div>
                            </div>
                            <div class="form-group ">
                            ...
                            <div class="form-group ">
                                ...
                                <div id="ctrl-tagihan-holder" class=" "> 
                                    <input id="ctrl-tagihan"  value="<?php  echo $data['tagihan']; ?>" type="number" placeholder="Enter Tagihan" step="any"  name="tagihan"  class="form-control " />
                                </div>
                            </div>
                            <div class="form-group ">
                                <label class="control-label" for="saldo">Saldo </label>
                                <div id="ctrl-saldo-holder" class=" "> 
                                    <input id="ctrl-saldo"  value="<?php  echo $data['saldo']; ?>" type="number" placeholder="Enter Saldo" step="any"  name="saldo"  class="form-control " />
                                </div>
                            </div>
                        </div>
