    ...
    <div  class="bg-light p-3 mb-3">
        <div class="container">
            <div class="row justify-content-between">
                <div class="col ">
                    <h5 class="font-weight-bold record-title">View Pelanggan Cafe</h5>
                </div>
            </div>
        </div>
    </div>
                ...
                <div class="col-md-12 comp-grid">
                    ...
                    <div  class="card  animated fadeIn page-content">
                        ...
                        <div class="p-3 d-flex">
                            ...
                            <a class="btn btn-sm btn-info"  href="<?php print_link("pelanggan_cafe/edit/$rec_id"); ?>">
                            <i class="material-icons">edit</i> Edit
                            </a>
                            <a class="btn btn-sm btn-danger record-delete-btn mx-1"  href="<?php print_link("pelanggan_cafe/delete/$rec_id?redirect=pelanggan_cafe"); ?>" data-prompt-msg="Are you sure you want to delete this record?" data-display-style="modal">
