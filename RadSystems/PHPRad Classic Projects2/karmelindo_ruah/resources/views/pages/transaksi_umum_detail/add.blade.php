    ...
    <div  class="bg-light p-3 mb-3">
        <div class="container">
            <div class="row justify-content-between">
                <div class="col ">
                    <h5 class="font-weight-bold record-title">Add New Transaksi Umum Detail</h5>
                </div>
            </div>
        </div>
    </div>
            ...
            <div class="row ">
                <div class="col-md-9 comp-grid">
                    ...
                    <div  class="card bg-light p-3 animated fadeIn page-content">
                        <!--[form-start]-->
                        <form id="transaksi_umum_detail-add-form" role="form" novalidate enctype="multipart/form-data" class="form page-form form-vertical needs-validation" action="{{ route('transaksi_umum_detail.store') }}" method="post">
                            @csrf
                            <div>
                                ...
                                <div class="form-group ">
                                    ...
                                    <div id="ctrl-nama-holder" class=" "> 
                                        <input id="ctrl-nama"  value="<?php echo get_value('nama') ?>" type="text" placeholder="Enter Nama"  name="nama"  class="form-control " />
                                    </div>
                                </div>
                                <div class="form-group ">
