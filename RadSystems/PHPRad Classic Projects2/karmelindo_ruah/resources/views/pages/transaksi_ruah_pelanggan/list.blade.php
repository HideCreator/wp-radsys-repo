    ...
    <div  class="bg-light p-3 mb-3">
        <div class="container-fluid">
            <div class="row justify-content-between">
                <div class="col ">
                    <h5 class="font-weight-bold record-title">Transaksi Ruah Pelanggan</h5>
                </div>
                <div class="col-md-3 ">
        ...
        <div class="container-fluid">
            <div class="row ">
                <div class="col-md-12 comp-grid">
                    <div class="">
                        <?php Html::page_bread_crumb("transaksi_ruah_pelanggan/index", $field_name, $field_value); ?>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="row ">
                <div class="col-md-12 comp-grid">
                    ...
                    <div  class="card  animated fadeIn page-content">
                        <div id="transaksi_ruah_pelanggan-list-records">
