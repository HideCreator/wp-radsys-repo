                                    ...
                                    <tbody class="page-data">
                                        ...
                                        <tr>
                                            <td class=" td-checkbox">
                                                <label class="custom-control custom-checkbox custom-control-inline">
                                                <input class="optioncheck custom-control-input" name="optioncheck[]" value="<?php echo $data['kd_saldo'] ?>" type="checkbox" />
                                                <span class="custom-control-label"></span>
                                                </label>
                                            </td>
                                            <th class="td-sno"><?php echo $counter; ?></th>
                                            <td class="td-kd_saldo">
                                                <a href="<?php print_link("saldo/view/$data[kd_saldo]") ?>"><?php echo $data['kd_saldo']; ?></a>
                                            </td>
                                            ...
                                            <td class="td-kd_pelanggan">
                                                ...
                                                data-pk="<?php echo $data['kd_saldo'] ?>" 
                                                data-url="<?php print_link("saldo/edit/" . urlencode($data['kd_saldo'])); ?>" 
                                            ...
                                            <td class="td-keterangan">
                                                <span  data-pk="<?php echo $data['kd_saldo'] ?>" 
                                                data-url="<?php print_link("saldo/edit/" . urlencode($data['kd_saldo'])); ?>" 
                                ...
                                <div class="row justify-content-center">    
                                    <div class="col-md-auto justify-content-center">    
                                        <div class="p-3 d-flex justify-content-between">    
                                            ...
                                            <?php Html :: import_form('saldo/importdata' , "Import Data", 'CSV , JSON'); ?>
                                        </div>
                                    </div>
                                    <div class="col">   
                                        <?php
