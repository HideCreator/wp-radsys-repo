    ...
    <div  class="bg-light p-3 mb-3">
        <div class="container-fluid">
            <div class="row justify-content-between">
                <div class="col ">
                    <h5 class="font-weight-bold record-title">Transaksi Cafe</h5>
                </div>
                <div class="col-md-auto ">
                    <a  class="btn btn btn-primary btn-block" href="<?php print_link("transaksi_cafe/add") ?>">
                    <i class="material-icons">add</i>                               
                    Add New Transaksi Cafe 
                    </a>
                </div>
                <div class="col-md-3 ">
        ...
        <div class="container-fluid">
            <div class="row ">
                <div class="col-md-12 comp-grid">
                    <div class="">
                        <?php Html::page_bread_crumb("transaksi_cafe/index", $field_name, $field_value); ?>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="row ">
                <div class="col-md-12 comp-grid">
                    ...
                    <div  class="card  animated fadeIn page-content">
                        <div id="transaksi_cafe-list-records">
                                ...
                                <table class="table  table-striped table-sm text-left">
                                    <thead class="table-header bg-light">
                                        <tr>
                                            ...
                                            <th class="td-sno">#</th>
                                            <th  class="td-kd_db_trk_cafe"> Kd Db Trk Cafe</th>
                                    ...
                                    <tbody class="page-data">
                                        ...
                                        <?php
                                            ...
                                            $rec_id = ($data['kd_db_trk_cafe'] ? urlencode($data['kd_db_trk_cafe']) : null);
                                            $counter++;
                                        ?>
                                        <tr>
                                            <td class=" td-checkbox">
                                                <label class="custom-control custom-checkbox custom-control-inline">
                                                <input class="optioncheck custom-control-input" name="optioncheck[]" value="<?php echo $data['kd_db_trk_cafe'] ?>" type="checkbox" />
                                                <span class="custom-control-label"></span>
                                                </label>
                                            </td>
                                            <th class="td-sno"><?php echo $counter; ?></th>
                                            <td class="td-kd_db_trk_cafe">
                                                <a href="<?php print_link("transaksi_cafe/view/$data[kd_db_trk_cafe]") ?>"><?php echo $data['kd_db_trk_cafe']; ?></a>
                                            </td>
                                            <td class="td-kd_trk_cafe">
                                                <span  data-step="any" 
                                                data-value="<?php echo $data['kd_trk_cafe']; ?>" 
                                                data-pk="<?php echo $data['kd_db_trk_cafe'] ?>" 
                                                data-url="<?php print_link("transaksi_cafe/edit/" . urlencode($data['kd_db_trk_cafe'])); ?>" 
                                            ...
                                            <td class="td-catatan">
                                                <span  data-pk="<?php echo $data['kd_db_trk_cafe'] ?>" 
                                                data-url="<?php print_link("transaksi_cafe/edit/" . urlencode($data['kd_db_trk_cafe'])); ?>" 
                                                data-name="catatan" 
                                            ...
                                            <td class="td-btn">
                                                <a class="btn btn-sm btn-success has-tooltip" title="View Record" href="<?php print_link("transaksi_cafe/view/$rec_id"); ?>">
                                                <i class="material-icons">visibility</i> 
                                                </a>
                                                <a class="btn btn-sm btn-info has-tooltip" title="Edit This Record" href="<?php print_link("transaksi_cafe/edit/$rec_id"); ?>">
                                                <i class="material-icons">edit</i> 
                                                </a>
                                                <a class="btn btn-sm btn-danger has-tooltip record-delete-btn" title="Delete this record" href="<?php print_link("transaksi_cafe/delete/$rec_id"); ?>" data-prompt-msg="Are you sure you want to delete this record?" data-display-style="modal">
                                ...
                                <div class="row justify-content-center">    
                                    <div class="col-md-auto justify-content-center">    
                                        <div class="p-3 d-flex justify-content-between">    
                                            <button data-prompt-msg="Are you sure you want to delete these records?" data-display-style="modal" data-url="<?php print_link("transaksi_cafe/delete/{sel_ids}"); ?>" class="btn btn-sm btn-danger btn-delete-selected d-none">
