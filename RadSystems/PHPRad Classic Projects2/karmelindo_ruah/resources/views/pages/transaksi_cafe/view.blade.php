    ...
    <div  class="bg-light p-3 mb-3">
        <div class="container">
            <div class="row justify-content-between">
                <div class="col ">
                    <h5 class="font-weight-bold record-title">View Transaksi Cafe</h5>
                </div>
            </div>
        </div>
    </div>
                ...
                <div class="col-md-12 comp-grid">
                    ...
                    <div  class="card  animated fadeIn page-content">
                        ...
                        <div id="page-report-body" class="">
                            <!-- Table Body Start -->
                            <div class="page-data">
                                <div class="border-top td-kd_db_trk_cafe p-2">
                                    <div class="row align-items-center">
                                        <div class="col">
                                            <div class="text-muted"> Kd Db Trk Cafe</div>
                                            <div class="font-weight-bold">
                                                <?php echo  $data['kd_db_trk_cafe'] ; ?>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                        ...
                        <div class="p-3 d-flex">
                            ...
                            <a class="btn btn-sm btn-info"  href="<?php print_link("transaksi_cafe/edit/$rec_id"); ?>">
                            <i class="material-icons">edit</i> Edit
                            </a>
                            <a class="btn btn-sm btn-danger record-delete-btn mx-1"  href="<?php print_link("transaksi_cafe/delete/$rec_id?redirect=transaksi_cafe"); ?>" data-prompt-msg="Are you sure you want to delete this record?" data-display-style="modal">
