    ...
    <div  class="bg-light p-3 mb-3">
        <div class="container">
            <div class="row justify-content-between">
                <div class="col ">
                    <h5 class="font-weight-bold record-title">Edit Transaksi Cafe</h5>
                </div>
            </div>
        </div>
    </div>
            ...
            <div class="row ">
                <div class="col-md-9 comp-grid">
                    ...
                    <div  class="card bg-light p-3 animated fadeIn page-content">
                        <!--[form-start]-->
                        <form novalidate  id="" role="form" enctype="multipart/form-data"  class="form page-form form-vertical needs-validation" action="<?php print_link("transaksi_cafe/edit/$rec_id"); ?>" method="post">
                        <!--[form-content-start]-->
                        @csrf
                        <div>
                            <div class="form-group ">
                                ...
                                <div id="ctrl-kd_trk_cafe-holder" class=" "> 
                                    <input id="ctrl-kd_trk_cafe"  value="<?php  echo $data['kd_trk_cafe']; ?>" type="number" placeholder="Enter Kd Trk Cafe" step="any"  required="" name="kd_trk_cafe"  class="form-control " />
                                </div>
                            </div>
                            <div class="form-group ">
                            ...
                            <div class="form-group ">
                                ...
                                <div id="ctrl-subtotal-holder" class=" "> 
                                    <input id="ctrl-subtotal"  value="<?php  echo $data['subtotal']; ?>" type="number" placeholder="Enter Subtotal" step="any"  name="subtotal"  class="form-control " />
                                </div>
                            </div>
                            <div class="form-group ">
                                <label class="control-label" for="ongkir">Ongkir </label>
                                <div id="ctrl-ongkir-holder" class=" "> 
                                    <input id="ctrl-ongkir"  value="<?php  echo $data['ongkir']; ?>" type="number" placeholder="Enter Ongkir" step="any"  name="ongkir"  class="form-control " />
                                </div>
                            </div>
                            <div class="form-group ">
                            ...
                            <div class="form-group ">
                                ...
                                <div id="ctrl-total_bayar-holder" class=" "> 
                                    <input id="ctrl-total_bayar"  value="<?php  echo $data['total_bayar']; ?>" type="number" placeholder="Enter Total Bayar" step="any"  name="total_bayar"  class="form-control " />
                                </div>
                            </div>
                            <div class="form-group ">
                                <label class="control-label" for="piutangtotal">Piutangtotal </label>
                                <div id="ctrl-piutangtotal-holder" class=" "> 
                                    <input id="ctrl-piutangtotal"  value="<?php  echo $data['piutangtotal']; ?>" type="number" placeholder="Enter Piutangtotal" step="any"  name="piutangtotal"  class="form-control " />
                                </div>
                            </div>
                            <div class="form-group ">
                                <label class="control-label" for="bayartotal">Bayartotal </label>
                                <div id="ctrl-bayartotal-holder" class=" "> 
                                    <input id="ctrl-bayartotal"  value="<?php  echo $data['bayartotal']; ?>" type="number" placeholder="Enter Bayartotal" step="any"  name="bayartotal"  class="form-control " />
                                </div>
                            </div>
                            <div class="form-group ">
                                <label class="control-label" for="dihapus">Dihapus </label>
                                <div id="ctrl-dihapus-holder" class=" "> 
                                    <input id="ctrl-dihapus"  value="<?php  echo $data['dihapus']; ?>" type="number" placeholder="Enter Dihapus" step="any"  name="dihapus"  class="form-control " />
                                </div>
                            </div>
                            <div class="form-group ">
                                <label class="control-label" for="kategori">Kategori </label>
                                <div id="ctrl-kategori-holder" class=" "> 
                                    <input id="ctrl-kategori"  value="<?php  echo $data['kategori']; ?>" type="text" placeholder="Enter Kategori"  name="kategori"  class="form-control " />
                                </div>
                            </div>
                            <div class="form-group ">
                                <label class="control-label" for="klot">Klot </label>
                                <div id="ctrl-klot-holder" class=" "> 
                                    <input id="ctrl-klot"  value="<?php  echo $data['klot']; ?>" type="text" placeholder="Enter Klot"  name="klot"  class="form-control " />
                                </div>
                            </div>
                            <div class="form-group ">
                                <label class="control-label" for="cabangtrk">Cabangtrk </label>
                                <div id="ctrl-cabangtrk-holder" class=" "> 
                                    <input id="ctrl-cabangtrk"  value="<?php  echo $data['cabangtrk']; ?>" type="text" placeholder="Enter Cabangtrk"  name="cabangtrk"  class="form-control " />
                                </div>
                            </div>
                        </div>
