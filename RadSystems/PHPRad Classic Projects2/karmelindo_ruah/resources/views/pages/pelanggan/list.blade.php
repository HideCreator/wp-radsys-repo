                                ...
                                <table class="table  table-striped table-sm text-left">
                                    <thead class="table-header bg-light">
                                        <tr>
                                            ...
                                            <th  class="td-alokasicafe"> Alokasicafe</th>
                                            <th class="td-btn"></th>
                                        </tr>
                                    </thead>
                                    <?php
                                    ...
                                    <tbody class="page-data">
                                        ...
                                        <tr>
                                            ...
                                            <td class="td-no_plg_lama">
                                                ...
                                                data-pk="<?php echo $data['kd_pelanggan'] ?>" 
                                                data-url="<?php print_link("pelanggan/edit/" . urlencode($data['kd_pelanggan'])); ?>" 
                                            ...
                                            <td class="td-catatan_pelanggan">
                                                <span  data-value="<?php echo $data['catatan_pelanggan']; ?>" 
                                                data-pk="<?php echo $data['kd_pelanggan'] ?>" 
                                                data-url="<?php print_link("pelanggan/edit/" . urlencode($data['kd_pelanggan'])); ?>" 
                                            ...
                                            <td class="td-prediksi_ongkir">
                                                <span  data-value="<?php echo $data['prediksi_ongkir']; ?>" 
                                                data-pk="<?php echo $data['kd_pelanggan'] ?>" 
                                                data-url="<?php print_link("pelanggan/edit/" . urlencode($data['kd_pelanggan'])); ?>" 
                                            ...
                                            <td class="td-tagihan">
                                                <span  data-value="<?php echo $data['tagihan']; ?>" 
                                                data-pk="<?php echo $data['kd_pelanggan'] ?>" 
                                                data-url="<?php print_link("pelanggan/edit/" . urlencode($data['kd_pelanggan'])); ?>" 
                                                data-name="tagihan" 
                                            ...
                                            <td class="td-saldo">
                                                <span  data-value="<?php echo $data['saldo']; ?>" 
                                                data-pk="<?php echo $data['kd_pelanggan'] ?>" 
                                                data-url="<?php print_link("pelanggan/edit/" . urlencode($data['kd_pelanggan'])); ?>" 
                                                data-name="saldo" 
                                            ...
                                            <td class="td-alokasicafe">
                                                <span  data-step="any" 
                                                data-value="<?php echo $data['alokasicafe']; ?>" 
                                                data-pk="<?php echo $data['kd_pelanggan'] ?>" 
                                                data-url="<?php print_link("pelanggan/edit/" . urlencode($data['kd_pelanggan'])); ?>" 
                                                data-name="alokasicafe" 
                                                data-title="Enter Alokasicafe" 
                                                data-placement="left" 
                                                data-toggle="click" 
                                                data-type="number" 
                                                data-mode="popover" 
                                ...
                                <div class="row justify-content-center">    
                                    <div class="col-md-auto justify-content-center">    
                                        <div class="p-3 d-flex justify-content-between">    
                                            ...
                                            <?php Html :: import_form('pelanggan/importdata' , "Import Data", 'CSV , JSON'); ?>
                                        </div>
                                    </div>
                                    <div class="col">   
                                        <?php
