    ...
    <div  class="bg-light p-3 mb-3">
        <div class="container">
            <div class="row justify-content-between">
                <div class="col ">
                    <h5 class="font-weight-bold record-title">View Roles</h5>
                </div>
            </div>
        </div>
    </div>
                ...
                <div class="col-md-12 comp-grid">
                    ...
                    <div  class="card  animated fadeIn page-content">
                        ...
                        <div class="p-3 d-flex">
                            ...
                            <?php } ?>
                            <?php if($can_delete){ ?>
                            <a class="btn btn-sm btn-danger record-delete-btn mx-1"  href="<?php print_link("roles/delete/$rec_id?redirect=roles"); ?>" data-prompt-msg="Are you sure you want to delete this record?" data-display-style="modal">
