    ...
    <div  class="bg-light p-3 mb-3">
        <div class="container">
            <div class="row justify-content-between">
                <div class="col ">
                    <h5 class="font-weight-bold record-title">Edit Pengguna</h5>
                </div>
            </div>
        </div>
    </div>
            ...
            <div class="row ">
                <div class="col-md-9 comp-grid">
                    ...
                    <div  class="card bg-light p-3 animated fadeIn page-content">
                        <!--[form-start]-->
                        <form novalidate  id="" role="form" enctype="multipart/form-data"  class="form page-form form-horizontal needs-validation" action="<?php print_link("pengguna/edit/$rec_id"); ?>" method="post">
                        <!--[form-content-start]-->
                        @csrf
                        <div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-8">
                                        <div id="ctrl-username-holder" class="input-group ">
                                            <input id="ctrl-username"  value="<?php  echo $data['username']; ?>" type="text" placeholder="Enter Nama Pengguna"  name="username"  data-url="componentsdata/pengguna_username_value_exist/" data-loading-msg="Checking availability ..." data-available-msg="Available" data-unavailable-msg="Not available" class="form-control  ctrl-check-duplicate" />
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-8">
                                        <div id="ctrl-password-holder" class="input-group ">
                                            <input id="ctrl-password"  value="<?php  echo $data['password']; ?>" type="password" placeholder="Enter Sandi"  name="password"  class="form-control  password password-strength" />
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-8">
                                        <div id="ctrl-photo-holder" class=" ">
                                            <textarea placeholder="Enter Photo" id="ctrl-photo"  rows="5" name="photo" class=" form-control"><?php  echo $data['photo']; ?></textarea>
