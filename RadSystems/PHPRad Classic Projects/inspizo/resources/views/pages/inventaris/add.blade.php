    ...
    <div  class="bg-light p-3 mb-3">
        <div class="container">
            <div class="row justify-content-between">
                <div class="col ">
                    <h5 class="font-weight-bold record-title">Add New Inventaris</h5>
                </div>
            </div>
        </div>
    </div>
            ...
            <div class="row ">
                <div class="col-md-9 comp-grid">
                    ...
                    <div  class="card bg-light p-3 animated fadeIn page-content">
                        <!--[form-start]-->
                        <form id="inventaris-add-form" role="form" novalidate enctype="multipart/form-data" class="form page-form form-horizontal needs-validation" action="{{ route('inventaris.store') }}" method="post">
                            @csrf
                            <div>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-sm-8">
                                            <div id="ctrl-nama_balat-holder" class=" ">
                                                <input id="ctrl-nama_balat"  value="<?php echo get_value('nama_balat') ?>" type="text" placeholder="Enter Nama Balat"  required="" name="nama_balat"  class="form-control " />
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-sm-8">
                                            <div id="ctrl-jml_awl-holder" class=" ">
                                                <input id="ctrl-jml_awl"  value="<?php echo get_value('jml_awl') ?>" type="number" placeholder="Enter Jml Awl" step="any"  required="" name="jml_awl"  class="form-control " />
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-sm-8">
                                            <div id="ctrl-jml_akh-holder" class=" ">
                                                <input id="ctrl-jml_akh"  value="<?php echo get_value('jml_akh') ?>" type="number" placeholder="Enter Jml Akh" step="any"  required="" name="jml_akh"  class="form-control " />
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-sm-8">
                                            <div id="ctrl-satuan-holder" class=" ">
                                                <input id="ctrl-satuan"  value="<?php echo get_value('satuan') ?>" type="text" placeholder="Enter Satuan"  required="" name="satuan"  class="form-control " />
                                            </div>
                                        </div>
                                    </div>
                                </div>
