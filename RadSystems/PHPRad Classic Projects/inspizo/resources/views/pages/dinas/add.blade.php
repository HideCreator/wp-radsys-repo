            ...
            <div class="row ">
                <div class="col-md-9 comp-grid">
                    ...
                    <div  class="card bg-light p-3 animated fadeIn page-content">
                        <!--[form-start]-->
                        <form id="dinas-add-form" role="form" novalidate enctype="multipart/form-data" class="form page-form form-horizontal needs-validation" action="{{ route('dinas.store') }}" method="post">
                            @csrf
                            <div>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-sm-8">
                                            <div id="ctrl-waktu-holder" class="input-group ">
                                                <input id="ctrl-waktu" class="form-control datepicker  datepicker"  required="" value="<?php echo get_value('waktu') ?>" type="time" name="waktu" placeholder="Enter Waktu" data-enable-time="true" data-min-date="" data-max-date=""  data-alt-format="H:i:S" data-date-format="H:i:S" data-inline="false" data-no-calendar="true" data-mode="single" /> 
