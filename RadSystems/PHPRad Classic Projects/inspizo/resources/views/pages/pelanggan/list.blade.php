                                ...
                                <table class="table  table-striped table-sm text-left">
                                    <thead class="table-header ">
                                        <tr>
                                            ...
                                            <th  class="td-nama_tempat"> Nama Tempat</th>
                                            <th  class="td-alamat"> Alamat</th>
                                            <th  class="td-telp"> Nomor Telepon</th>
                                            <th  class="td-jenis_usaha"> Jenis Usaha</th>
                                            <th class="td-btn"></th>
                                        </tr>
                                    </thead>
                                    <?php
                                    ...
                                    <tbody class="page-data">
                                        ...
                                        <tr>
                                            ...
                                            <td class="td-id_pelanggan">
                                                <a href="<?php print_link("pelanggan/view/$data[id_pelanggan]") ?>"><?php echo $data['id_pelanggan']; ?></a>
                                            </td>
                                            <td class="td-nama_pelanggan">
                                                <?php echo  $data['nama_pelanggan'] ; ?>
                                            </td>
                                            <td class="td-nama_tempat">
