                ...
                <div class="col-md-9 comp-grid">
                    ...
                    <div  class="card bg-light p-3 animated fadeIn page-content">
                        ...
                        <form id="pelanggan-add-form" role="form" novalidate enctype="multipart/form-data" class="form page-form form-horizontal needs-validation" action="{{ route('pelanggan.store') }}" method="post">
                            @csrf
                            <div>
                                <input id="ctrl-id_pelanggan"  value="<?php echo get_value('id_pelanggan') ?>" type="hidden" placeholder="Enter Id Pelanggan"  required="" name="id_pelanggan"  class="form-control " />
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-sm-8">
                                            <div id="ctrl-nama_tempat-holder" class="input-group ">
                                                <input id="ctrl-nama_tempat"  value="<?php echo get_value('nama_tempat') ?>" type="text" placeholder="Enter Nama Tempat"  required="" name="nama_tempat"  class="form-control " />
                                                <div class="input-group-append">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-sm-8">
                                            <div id="ctrl-alamat-holder" class=" ">
                                                <input id="ctrl-alamat"  value="<?php echo get_value('alamat') ?>" type="text" placeholder="Enter Alamat"  required="" name="alamat"  class="form-control " />
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                        ...
                                        <div class="col-sm-8">
                                            <div id="ctrl-jenis_usaha-holder" class=" ">
                                                <?php
                                                    ...
                                                    $checked = Html::get_field_checked('jenis_usaha', $value, "");
                                                ?>
