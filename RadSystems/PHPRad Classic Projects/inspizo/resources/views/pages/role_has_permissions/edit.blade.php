    ...
    <div  class="bg-light p-3 mb-3">
        <div class="container">
            <div class="row justify-content-between">
                <div class="col ">
                    <h5 class="font-weight-bold record-title">Edit Role Has Permissions</h5>
                </div>
            </div>
        </div>
    </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-8">
                                        <div id="ctrl-role_id-holder" class=" ">
                                            <input id="ctrl-role_id"  value="<?php  echo $data['role_id']; ?>" type="number" placeholder="Enter Role Id" step="any"  required="" name="role_id"  class="form-control " />
                                        </div>
                                    </div>
                                </div>
                            </div>
