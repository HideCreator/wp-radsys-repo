						...
						<div class="<?php echo $detail_page_class; ?>">
							...
							?>
								| <small class="text-primary">Page :
									<select style="display:inline-block;width:70px" id="formpage<?php echo $form_id ?>" onchange="$('#form<?php echo $form_id ?>').submit()" name="page" class="custom form-control form-control-sm page-num">
										<?php
							...
							?> |
								<small class="text-muted">
									Limit
									<select style="display:inline-block;width:70px" id="formlimit<?php echo $form_id ?>" onchange="$('#form<?php echo $form_id ?>').submit()" name="limit" class="custom form-control form-control-sm">
										<?php
