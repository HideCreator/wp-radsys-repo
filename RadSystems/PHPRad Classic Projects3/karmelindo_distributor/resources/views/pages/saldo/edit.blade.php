                    ...
                    <div  class="card bg-light p-3 animated fadeIn page-content">
                        ...
                        <div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-8">
                                        <div id="ctrl-kd_saldo-holder" class=" ">
                                            <input id="ctrl-kd_saldo"  value="<?php  echo $data['kd_saldo']; ?>" type="number" placeholder="Enter Kd Saldo" step="any"  required="" name="kd_saldo"  class="form-control " />
                                        </div>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-8">
                                        <div id="ctrl-kd_trk-holder" class=" ">
                                            <input id="ctrl-kd_trk"  value="<?php  echo $data['kd_trk']; ?>" type="text" placeholder="Enter Kd Trk"  name="kd_trk"  class="form-control " />
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="form-group ">
                                <div class="row">
                                    <div class="col-sm-4">
                                        <label class="control-label" for="simpanan">Simpanan <span class="text-danger">*</span></label>
                                    </div>
                                    <div class="col-sm-8">
                                        <div id="ctrl-simpanan-holder" class=" ">
                                            <input id="ctrl-simpanan"  value="<?php  echo $data['simpanan']; ?>" type="number" placeholder="Enter Simpanan" step="any"  required="" name="simpanan"  class="form-control " />
                                        </div>
                                    </div>
                                </div>
                            </div>
